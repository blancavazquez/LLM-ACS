...
Run the script "1_selection_patNSTEMI.sql" available in the [repository](https://github.com/blancavazquez/Riskmarkers_ACS/blob/master/sql_extraction/nstemi/1selection_subject_ids.sql)
